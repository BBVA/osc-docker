...
[![Docker Pulls](https://img.shields.io/docker/pulls/bbvalabs/osc-docker.svg)](https://hub.docker.com/r/engapa/osc-docker/)
[![Docker Stars](https://img.shields.io/docker/stars/bbvalabs/osc-docker.svg)](https://hub.docker.com/r/engapa/osc-docker/)
...
Now run a docker container using this image (build it locally or download from dockerhub.com: bbvalabs/osc-docker) and the credentials file, when
...
... type your password for tenant_name...
